BASE_PATH = "C:\\Users\\HP\\Downloads\\System_Monitor\\System_Monitor\\"
...
a=[5208,3424,3908,5192,8712,9344,11080,11460,12036,12080,12316,13344,13628,14012,14272,15656,17156] 
def get_size(bytes):
    """
...
if __name__ == "__main__":
    ...
    if n == 0:
        with open(BASE_PATH + 'proc.txt', 'w') as file:
                file.write(df.to_html())
        #print(df.to_string())
    elif n > 0:
        df.head(n).to_html(buf=(BASE_PATH + 'proc.txt'), justify='center')
        # with open("C:\\dev\\projects\\OS_Project\\System_Monitor\\proc.txt", 'w') as file:
                # file.write(df.head(n).to_html(buf="C:\\dev\\projects\\OS_Project\\System_Monitor\\proc.txt", justify='center'))
